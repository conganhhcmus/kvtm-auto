...
class ScriptManager:
    ...
    def validate_script_structure(self, script_file: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            validation_result['valid'] = (
                validation_result['has_main_function'] and
    ...
    def _extract_script_metadata(self, script_file: Path) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.warning(f"No SCRIPT_META found in {script_file.name}, creating basic metadata")
            return {
                'id': script_file.stem,
    ...
    def _normalize_script_meta(self, script_meta: Dict[str, Any], script_file: Path) -> Dict[str, Any]:
