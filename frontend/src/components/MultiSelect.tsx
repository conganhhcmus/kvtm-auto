            ...
            <div className="p-2 border-b border-gray-100">
              <button
                onClick={() => {
                  ...
                  const hasAll = allFilteredValues.every(val => values.includes(val))
                  if (hasAll) {
              ...
              >
                {filteredOptions.every(opt => values.includes(opt.value)) ? 'Deselect All' : 'Select All'}
              </button>
            </div>
          )}
              ...
              filteredOptions.map((option) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 hover:bg-blue-50 focus:bg-blue-50 transition-colors flex items-center ${
