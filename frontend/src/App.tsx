...
import { Play, Square, ChevronDown, ChevronUp, MonitorOff } from 'lucide-react'
...
function App() {
    ...
    const deviceOptions = devices.map((device: Device) => ({
        ...
        description: `Status: ${device.device_status}${device.screen_size ? ` | Size: ${device.screen_size[0]}x${device.screen_size[1]}` : ''}`
    }))
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-500 via-purple-600 to-indigo-700">
            <div className="container mx-auto px-4 py-4 sm:py-8 max-w-7xl">
                <div className="text-center mb-12">
                    <div className="space-y-3">
                        ...
                        <div className="flex justify-center items-center space-x-4 pt-2">
                            <div className="w-1 h-1 bg-blue-200 rounded-full animate-bounce" style={{animationDelay: '0ms'}}></div>
                            <div className="w-1 h-1 bg-blue-300 rounded-full animate-bounce" style={{animationDelay: '150ms'}}></div>
                            <div className="w-1 h-1 bg-blue-200 rounded-full animate-bounce" style={{animationDelay: '300ms'}}></div>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative z-10 bg-white rounded-xl shadow-2xl p-6 sm:p-8 mb-8 backdrop-blur-sm bg-opacity-95">
                    ...
                    <div className={`${isControlPanelExpanded ? 'block' : 'hidden lg:block'} transition-all duration-300`}>
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                        <div className="flex-1">
                                            ...
                                            <p className="text-sm text-gray-600 mt-1">
                                                Script: <span className="font-medium">{device.current_script || 'No script'}</span>
                                            </p>
                                            {device.last_seen && (
                                        ...
                                        {/* Action buttons - Responsive: 1x4 mobile, 2x2 tablet, 4x1 desktop */}
                                        <div className="flex flex-col gap-2 sm:grid sm:grid-cols-2 sm:gap-2 lg:flex lg:flex-row lg:space-x-2">
                                            <button
